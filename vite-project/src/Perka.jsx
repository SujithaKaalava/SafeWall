...
const Perka = ({ selected, onChange }) => {
  // Function to handle checkbox state changes
  function handleCbClick(ev) {
    const { checked, name } = ev.target;  // Get checkbox status and its name
    if (checked) {
      // If checked, add the name to the selected array
      onChange([...selected, name]);
    } else {
      // If unchecked, remove the name from the selected array
